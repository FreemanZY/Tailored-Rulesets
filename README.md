...
Observed Meituan and Sankuai delivery hosts, JD Cloud shared-object-storage hosts, and 300hu service and video-delivery hosts remain exact manual rules. Their parent namespaces can serve multiple workloads or tenants, so the observations do not justify suffix-wide routing.
